...
BATCH_B_DIR = ROOT / "research" / "batches" / "batch_b_lm_and_seq_models"
BATCH_B_KEYS: tuple[str, ...] = ("7", "8", "9", "10", "11", "12", "13")
...
def build_batch_b_payload() -> dict[str, object]:
    chapter_map = get_chapter_map()
    chapters: list[dict[str, object]] = []
    for key in BATCH_B_KEYS:
        ...
        "chapters": [
            {
                ...
                "fixture_path": f"research/batches/batch_b_lm_and_seq_models/fixtures/{chapter['fixture_filename']}",
                "eval_pack_path": f"research/batches/batch_b_lm_and_seq_models/eval_packs/{chapter['eval_pack_filename']}",
            }
...
def write_batch_b_artifacts(base_dir: Path = BATCH_B_DIR) -> Path:
    ...
    manifest_path = base_dir / "BATCH_B_MANIFEST.json"
