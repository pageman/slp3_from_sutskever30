...
BATCH_D_DIR = ROOT / "research" / "batches" / "batch_d_structure_and_ie"
BATCH_D_KEYS: tuple[str, ...] = ("17", "18", "19", "20", "21")
...
def build_batch_d_payload() -> dict[str, object]:
    chapter_map = get_chapter_map()
    chapters: list[dict[str, object]] = []
    for key in BATCH_D_KEYS:
        ...
        "chapters": [
            {
                ...
                "fixture_path": f"research/batches/batch_d_structure_and_ie/fixtures/{chapter['fixture_filename']}",
                "eval_pack_path": f"research/batches/batch_d_structure_and_ie/eval_packs/{chapter['eval_pack_filename']}",
            }
...
def write_batch_d_artifacts(base_dir: Path = BATCH_D_DIR) -> Path:
    ...
    manifest_path = base_dir / "BATCH_D_MANIFEST.json"
