...
BATCH_C_DIR = ROOT / "research" / "batches" / "batch_c_speech"
BATCH_C_KEYS: tuple[str, ...] = ("14", "15", "16")
...
def build_batch_c_payload() -> dict[str, object]:
        ...
        "chapters": [
            {
                ...
                "fixture_path": f"research/batches/batch_c_speech/fixtures/{chapter['fixture_filename']}",
                "eval_pack_path": f"research/batches/batch_c_speech/eval_packs/{chapter['eval_pack_filename']}",
            }
...
def write_batch_c_artifacts(base_dir: Path = BATCH_C_DIR) -> Path:
    ...
    manifest_path = base_dir / "BATCH_C_MANIFEST.json"
