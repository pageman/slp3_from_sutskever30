...
BATCH_A_DIR = ROOT / "research" / "batches" / "batch_a_classical_foundations"
BATCH_A_KEYS: tuple[str, ...] = ("2", "3", "4", "5", "6", "A", "B", "C", "D")
...
def build_batch_a_payload() -> dict[str, object]:
        ...
        "chapters": [
            {
                ...
                "fixture_path": f"research/batches/batch_a_classical_foundations/fixtures/{chapter['fixture_filename']}",
                "eval_pack_path": f"research/batches/batch_a_classical_foundations/eval_packs/{chapter['eval_pack_filename']}",
            }
...
def write_batch_a_artifacts(base_dir: Path = BATCH_A_DIR) -> Path:
    ...
    manifest_path = base_dir / "BATCH_A_MANIFEST.json"
