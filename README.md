...
- Current split: `12 FULL`, `2 DIRECT`, `3 ADAPTED`, `11 SCAFFOLDED`

All runners are NumPy-only and executable. Batch 1 upgraded chapters `2-6`, batch 2 upgraded chapters `9-10`, batch 3 upgraded chapters `14-16`, and the first structured-prediction sub-batch upgraded chapters `17` and `21`, to fuller chapter contracts with evaluation and failure-case reporting. The remaining `SCAFFOLDED` chapters are not yet full implementations.
